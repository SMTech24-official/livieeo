...
router.patch("/:id", fileUploader_1.fileUploader.upload.array("podcastFiles", 5), textToJsonParser_1.default, podcast_controller_1.PodcastControllers.updatePodcast);
...
router.get("/activities", podcast_controller_1.PodcastControllers.getActivities);
