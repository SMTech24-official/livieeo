...
const updatePodcast = async (id, payload, thumbImageFile, podcastFiles) => {
    if (podcastFiles && podcastFiles.length > 0) {
    ...
    if (thumbImageFile) {
        const uploadThumbImageFile = await fileUploader_1.fileUploader.uploadToCloudinary(thumbImageFile);
