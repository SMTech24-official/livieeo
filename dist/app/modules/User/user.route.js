...
router.patch("/update-profile", (0, auth_1.default)(client_1.UserRole.USER, client_1.UserRole.ADMIN), fileUploader_1.fileUploader.upload.single("file"), textToJsonParser_1.default, user_controller_1.UserController.updateProfile);
