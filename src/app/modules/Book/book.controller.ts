...
const updateBook = catchAsync(async (req, res) => {
  ...
  const result = await BookServices.updateBookInDB(
...
const getNewBooks = catchAsync(async (req, res) => {
  const result = await BookServices.getNewBooksFromDB(req.query);
  sendResponse(res, {
    statusCode: httpStatus.OK,
    success: true,
...
const updatePublishedStatus = catchAsync(async (req, res) => {
  const result = await BookServices.updatePublishedStatus(
    req.params.id as string,
...
const getRelatedBooks = catchAsync(async (req, res) => {
  ...
  const result = await BookServices.getRelatedBooksFromDB(
    bookId as string,
    req.query
  );
  sendResponse(res, {
...
const ratingToBook = catchAsync(async (req, res) => {
  const { bookId } = req.params;
  const result = await BookServices.ratingToBook(
    bookId as string,
    req.body.rating
  );
  sendResponse(res, {
