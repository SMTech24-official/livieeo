...
router.get("/:userId", auth(UserRole.USER, UserRole.ADMIN), UserController.getUserById)
router.patch("/update-profile", auth(UserRole.USER, UserRole.ADMIN), fileUploader.upload.single("file"), textToJSONParser, UserController.updateProfile)
