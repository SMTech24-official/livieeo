...
//     padding: 8px;
//     background: linear-gradient(135deg,#b993d6,#8ca6db,#ffd166);
//   }
//   .inner {
...
//     letter-spacing:2px; font-weight:bold; font-size:12px; color:#64748b;
//   }
//   .title {
...
//   .name {
//     text-align:center; margin-top:18mm; font-size:40px; font-weight:700;
//   }
//   .line { width: 120mm; height:2px; background:#e2e8f0; margin:10px auto 0; }
//   .course {
//     text-align:center; margin-top:10mm; font-size:18px; color:#334155;
//   }
//   .badge {
//     display:inline-block; padding:8px 14px; border-radius:999px;
//     background:linear-gradient(90deg,#f6d365,#fda085);
//     color:#1f2937; font-weight:700; font-size:12px; letter-spacing:1px;
//   }
//   .meta {
//     margin-top:22mm; display:flex; justify-content:space-between; align-items:flex-end;
//   }
//   .meta .block { font-size:12px; color:#475569; }
//   .meta .val { font-weight:700; color:#0f172a; margin-top:2px; }
//   .sign {
//     margin-top:18mm; display:flex; justify-content:space-between; align-items:center;
//   }
//   .sign .box {
//     width:66mm; text-align:center;
//   }
//   .sign .bar { height:2px; background:#e2e8f0; margin-bottom:6px; }
//   .qr { width: 28mm; height:28mm; }
//   .foot {
//     position:absolute; left:0; right:0; bottom:0;
//     background:#f8fafc; border-top:1px solid #e2e8f0; padding:10px 42px; font-size:11px; color:#64748b;
...
//       <span class="badge">${p.courseTitle}</span><br/>
...
//     font-family: 'Georgia', serif;
//     background: #f8fafc;
//     overflow: hidden; /* stop content overflow to next page */
//   }
//   .wrap {
//     position: relative;
//     width: 190mm; height: 277mm; /* keep inside A4 with safe margin */
//     margin: 10mm auto;
//     background: #fff;
//     box-shadow: 0 8px 40px rgba(0,0,0,.08);
//     border-radius: 12px;
...
//     height: calc(100% - 16px); /* exact fit */
//     box-sizing: border-box;
//     display: flex;
//     flex-direction: column;
//     justify-content: space-between; /* auto distribute */
//   }
//   /* Watermark */
//   .wm {
//     position:absolute; inset: 0; pointer-events:none; opacity:.05;
...
//     font-size:44px; letter-spacing:2px; font-weight:700;
//   }
//   .subtitle { text-align:center; color:#64748b; margin-top:4px; }
//   .name {
//     text-align:center; margin-top:14mm; font-size:36px; font-weight:700;
//   }
//   .line { width: 120mm; height:2px; background:#e2e8f0; margin:10px auto 0; }
//   .course {
//     text-align:center; margin-top:10mm; font-size:18px; color:#334155;
...
//   }
//   .meta {
//     margin-top:18mm; display:flex; justify-content:space-between; align-items:flex-end;
//   }
//   .meta .block { font-size:12px; color:#475569; }
//   .meta .val { font-weight:700; color:#0f172a; margin-top:2px; }
//   .sign {
//     margin-top:16mm; display:flex; justify-content:space-between; align-items:center;
//   }
//   .sign .box {
//     width:66mm; text-align:center;
//   }
...
//     padding:8px 36px; font-size:11px; color:#64748b;
//     display:flex; justify-content:space-between;
//   }
// </style>
// </head>
